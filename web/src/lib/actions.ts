 ...
 * SQL from the app's own team since the cross-tenant lockdown, so a regular
 * signed-in user would get a 403 from `app.db.*`.
 */
...
/** Call an execute/batch action; resolves to the write metadata. */
